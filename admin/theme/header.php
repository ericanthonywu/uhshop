...
$sql_profile = mysqli_query($inventory,"SELECT * FROM session WHERE session_id = '$token'");
$data_profile = mysqli_fetch_array($sql_profile);
$level = $data_profile['session_role'];
?>
				...
				<div class="m-stack m-stack--ver m-stack--general">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						<a href="<?=$base_url?>" class="m-brand__logo-wrapper">
							...
							?>
							<img alt="" src="<?=$base_assets?>inventory/logo/<?=$data_pengaturan_sistem['logo']?>" />
							<?
							}
							?>
						</a>
							...
							<li class="m-nav__item m-topbar__user-profile  m-dropdown m-dropdown--medium m-dropdown--arrow  m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" m-dropdown-toggle="click">
								<a href="javascript:;" class="m-nav__link m-dropdown__toggle">
									<span class="m-topbar__userpic m--hide">
										<img src="<?=$base_assets?>inventory/avatar/<?=$data_profile['session_image']?>" class="m--img-rounded m--marginless m--img-centered" alt="" />
									</span>
									<span class="m-nav__link-icon m-topbar__usericon">
										<span class="m-nav__link-icon-wrapper"><i class="flaticon-user-ok"></i></span>
									</span>
									<span class="m-topbar__username m--hide"><?=$data_profile['session_name']?></span>
								</a>
								<div class="m-dropdown__wrapper">
									<span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
									<div class="m-dropdown__inner">
										<div class="m-dropdown__header m--align-center">
											<div class="m-card-user m-card-user--skin-light">
												<div class="m-card-user__pic">
													<img src="<?=$base_assets?>inventory/avatar/<?=$data_profile['session_image']?>" class="m--img-rounded m--marginless" alt="" />
												</div>
												<div class="m-card-user__details">
													<span class="m-card-user__name m--font-weight-500"><?=$data_profile['session_name']?></span>
													<a href="" class="m-card-user__email m--font-weight-300 m-link"><?=$data_profile['session_email']?></a>
												</div>
											</div>
										</div>
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<li class="m-nav__item">
														<a href="<?=$base_url?>signout" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
													</li>
												</ul>
											</div>
										</div>
