...
if(isset($_SESSION['token_inventory'])){
    $kode = $_GET['kode'];
    $sql = mysqli_query($inventory,"select * from slider where id = $kode");
    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post" id="form_ubah_slider">
                ...
                <div class="m-portlet__body">
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                            <label>Judul :</label>
                            <input type="text" name="judul" id="judul" class="form-control m-input" value="<?=$data['judul']?>" placeholder="Masukkan judul slider">
                            <span class="m-form__help">Masukkan judul slider</span>
                        </div>
                        <div class="col-lg-4">
                            <label>Konten :</label>
                            <input type="text" name="konten" id="konten" class="form-control m-input" value="<?=$data['konten']?>" placeholder="Masukkan Konten slider">
