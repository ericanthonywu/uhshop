...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
			...
			<div class="m-portlet__head-tools">
				<ul class="m-portlet__nav">
					<li class="m-portlet__nav-item">
						<button data-toggle="m-tooltip" title="Tambah Barang" data-placement="top" onclick="window.location.href='<?=$base_url?>barang/tambah'" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air">
							<span>
		...
		<div class="m-portlet__body">
			<!--begin: Datatable -->
			<table class="table table-striped- table-bordered table-hover table-checkable" id="data_barang">
				<thead>
					<tr>
						<th> No </th>
						<th> Kode </th>
